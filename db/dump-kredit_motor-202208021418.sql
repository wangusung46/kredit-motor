...
INSERT INTO `admin` VALUES (1,'1','1','1','Admin'),(2,'2','2','2','Bagian Keuangan');
...
INSERT INTO `angsur` VALUES (1,1,'2022-08-05'),(2,1,'2022-08-05'),(3,1,'2022-08-05'),(4,2,'2022-08-03');
...
CREATE TABLE `kredit` (
  ...
  `jumlah_bulan` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `kredit` VALUES (1,1,1,'2022-08-03',1,11),(2,2,1,'2022-08-03',1,17);
...
INSERT INTO `motor` VALUES (1,'asdf','11000000');
...
INSERT INTO `pembeli` VALUES (1,'Mirna','Perempuan','dszb','drh','zsbv','szg','szg','txrh','drh','zsdgrezsr'),(2,'Andi','Laki-laki','dszb','drh','zsbv','szg','szg','txrh','drh','zsdgrezsr');
...
INSERT INTO `sales` VALUES (1,'dsa');
...
-- Dump completed on 2022-08-02 14:18:54
